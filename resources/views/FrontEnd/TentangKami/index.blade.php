...
<div class="section_tentang_kami">
    ...
    <div class="fasilitas">
        ...
        <div class="listFasilitas" id="fasilitas">
            <div class="item_list">
                <h5>Ini Judul</h5>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cumque porro quasi inventore. Odit placeat vitae voluptate minus! Tenetur, eos magnam.</p>
            </div>
        </div>
    </div>
    <div class="layanan">
    ...
    <div class="lokasi">
        ...
        <div>
            ...
            <p id="lokasi">Klinik Arhanud Kota Batu terletak di Pendem, Kec. Junrejo, Kota Batu, Jawa Timur dengan Kode Pos 65324</p>
        </div>
    </div>
    <div class="mitra">
