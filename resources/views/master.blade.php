    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ set_menu(['lab', 'lab.tambah', 'lab.edit']) }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#halamanHome"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-tint"></i>
                    <span>Home</span>
                </a>
                <div id="halamanHome" class="collapse {{ set_show(['lab', 'lab.tambah', 'lab.edit']) }}"
            ...
            <li class="nav-item {{ set_menu(['lab', 'lab.tambah', 'lab.edit']) }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#halamanTentangKami"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-tint"></i>
                    <span>Tentang Kami</span>
                </a>
                <div id="halamanTentangKami" class="collapse {{ set_show(['lab', 'lab.tambah', 'lab.edit']) }}"
                    aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item " href="{{ route('tentangKami.tentangKami', ['id' => 'informasiKlinik']) }}">Informasi Klinik</a>
                        <a class="collapse-item " href="{{ route('tentangKami.tentangKami', ['id' => 'visiMisi']) }}">Visi Misi</a>
                        <a class="collapse-item " href="{{ route('fasilitas') }}">Fasilitas</a>
                        <a class="collapse-item " href="{{ route('layanan') }}">Layanan</a>
                        <a class="collapse-item " href="{{ route('tentangKami.tentangKami', ['id' => 'lokasi']) }}">Lokasi</a>
                        <a class="collapse-item " href="{{ route('kemitraan') }}">Kemitraan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item {{ set_menu(['lab', 'lab.tambah', 'lab.edit']) }}">
                ...
                <div id="collapseThree" class="collapse {{ set_show(['lab', 'lab.tambah', 'lab.edit']) }}"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ set_menu('lab') }}" href="{{ route('lab') }}">Daftar Fasilitas
                            Lab</a>
            ...
            <li
                ...
                <div id="collapsePages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ set_menu(['register']) }}" href="{{route('register')}}">Tambah
                            Pengguna Baru</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <label class="form-control bg-light border-0 small" aria-label="Search"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small">{{ucfirst(Auth::user()->name) }}</span>
