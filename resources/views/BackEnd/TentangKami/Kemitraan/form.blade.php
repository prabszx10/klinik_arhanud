<div class="card shadow mb-4" id="data_table">
    <div class="card-header d-sm-flex align-items-center justify-content-between py-3">
        <h6 class="m-0 font-weight-bold text-primary formTitle">Tambah Kemitraan</h6>
    </div>
    <div class="card-body">
        <form class="user" action="javascript:onSave()" method="post" id="formData" autocomplete="off">
            ...
            <div class="form-group row">
                <div class="col-sm-12 mb-3">
                    ...
                    <input type="text" class="form-control " name="nama" id="nama" placeholder="Nama Kemitraan" required>
                </div>
                <div class="col-sm-12 mb-3">
