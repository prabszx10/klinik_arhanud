<div class="card shadow mb-4" id="data_table">
    <div class="card-header d-sm-flex align-items-center justify-content-between py-3">
        <h6 class="m-0 font-weight-bold text-primary formTitle">Tambah Layanan</h6>
    </div>
    <div class="card-body">
        <form class="user" action="javascript:onSave('layanan')" method="post" id="formData" autocomplete="off">
            {{csrf_field()}}
